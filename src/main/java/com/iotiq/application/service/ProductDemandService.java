...
public class ProductDemandService {
    ...
    public List<ProductDemand> getAssignedDemandsInProgressForSeller(Seller seller) {
        return productDemandRepository.findAllBySellerAndIsActiveTrueAndStatus(seller, RequestStatus.IN_PROGRESS);
    }
